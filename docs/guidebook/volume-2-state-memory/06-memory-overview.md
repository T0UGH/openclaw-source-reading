...
title: 06｜Memory 总览：OpenClaw 如何让 Agent 真正“有记忆” 机制图
type: memory-map
purpose: 用一张正式技术架构图解释“OpenClaw 的 memory 由哪些层组成？”
prompt_seed: 生成一张 16:9 中文技术架构图，主题是 OpenClaw 源码阅读第 06 篇：Memory 总览：OpenClaw 如何让 Agent 真正“有记忆”。图中只保留少量标签，突出层次、边界和主链路；高对比、无 logo、无水印，不要装饰性插画。
