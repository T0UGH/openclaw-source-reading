...
title: 08｜Memory Flush 与 Dreaming：OpenClaw 如何防止上下文在压缩时丢失 机制图
type: memory-map
purpose: 用一张正式技术架构图解释“长对话压缩前，OpenClaw 如何避免重要信息消失？”
prompt_seed: 生成一张 16:9 中文技术架构图，主题是 OpenClaw 源码阅读第 08 篇：Memory Flush 与 Dreaming：OpenClaw 如何防止上下文在压缩时丢失。图中只保留少量标签，突出层次、边界和主链路；高对比、无 logo、无水印，不要装饰性插画。
