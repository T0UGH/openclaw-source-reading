...
- 能解释 Background Tasks 是 detached work 的账本，而不是 scheduler 或新 Agent 类型。
- 能看懂 task lifecycle、ownership、requester route 和 completion delivery 的关系。
- 能说明 Subagent 为什么只是 detached work 的典型来源之一。
