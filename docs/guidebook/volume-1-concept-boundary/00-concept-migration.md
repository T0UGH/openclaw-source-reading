...
- 能说清 Claude Code/coding agent 心智模型迁移到 OpenClaw 时，哪些概念必须换掉。
- 能区分 prompt、event source、routed session、workspace、delivery 在 OpenClaw 里的位置。
- 能带着“个人 AI runtime”这条主线进入后续章节。
